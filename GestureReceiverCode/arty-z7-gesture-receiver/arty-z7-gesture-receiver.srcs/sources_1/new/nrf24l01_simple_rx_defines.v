...
`define VAL_RF_SETUP        8'h07      // 1Mbps, 0dBm (best range for RX)
...
`define STATE_RX_WAIT           5'd11  // Wait for RX_DR interrupt
`define STATE_RX_READ_PAYLOAD_CMD 5'd12 // Send read payload command
`define STATE_RX_READ_PAYLOAD_BYTE 5'd13 // Read payload bytes
`define STATE_RX_CLEAR_IRQ      5'd14  // Clear RX_DR interrupt